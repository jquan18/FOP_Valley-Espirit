package FOPFinalProject;

public class Story {
static void startPrintStory(){
try{
...
static void printLoseStory(String name){
try{
    String s = "The last thing you see is the gaping maw of the monster in front of you as it slowly approaches, ready to devour you whole.\r\n" + //
        ...
        "\"\033[1;34m"+name+"\033[0m\033[0;30m, your time has not come yet. \033[0;31mThe Earth\033[0;30m has chosen \033[1;37m\u001B[4myou\033[0m\033[0;30m, and it is unwilling to let you leave so easily. Arise once more, and conquer \u001B[4m\033[0;31mFOP Valley\033[0m\033[0;30m once and for all.\"";    
char [] c = s.toCharArray();
for(int i = 0;i<c.length;i++){
    System.out.print(c[i]);
    Thread.sleep(30);
...
public static void main(String[] args) {
    Story.startPrintStory();
    Story.printLoseStory("Nathan");
    Story.printWinStory();
}
}
